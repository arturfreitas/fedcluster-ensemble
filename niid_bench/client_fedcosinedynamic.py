...
class FlowerClientFedCosineDynamic(fl.client.NumPyClient):
...
def gen_client_fn(
...
) -> Callable[[str], FlowerClientFedCosineDynamic]:  # pylint: disable=too-many-arguments
    ...
    def client_fn(cid: str) -> FlowerClientFedCosineDynamic:
        ...
        return FlowerClientFedCosineDynamic(
            net,
            trainloader,
            valloader,
            device,
