...
class FlowerClientFedCosineCluster(fl.client.NumPyClient):
...
def gen_client_fn(
...
) -> Callable[[str], FlowerClientFedCosineCluster]:  # pylint: disable=too-many-arguments
    ...
    def client_fn(cid: str) -> FlowerClientFedCosineCluster:
        ...
        return FlowerClientFedCosineCluster(
            net,
            trainloader,
            valloader,
            device,
