...
class FlowerClientFedPid(fl.client.NumPyClient):
...
def gen_client_fn(
...
) -> Callable[[str], FlowerClientFedPid]:  # pylint: disable=too-many-arguments
    ...
    def client_fn(cid: str) -> FlowerClientFedPid:
